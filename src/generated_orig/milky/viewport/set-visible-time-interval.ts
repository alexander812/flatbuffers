...
export class SetVisibleTimeInterval implements flatbuffers.IUnpackableObject<SetVisibleTimeIntervalT> {
  ...
  static getRootAsSetVisibleTimeInterval(
    bb: flatbuffers.ByteBuffer,
    obj?: SetVisibleTimeInterval,
  ): SetVisibleTimeInterval {
    return (obj || new SetVisibleTimeInterval()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsSetVisibleTimeInterval(
    bb: flatbuffers.ByteBuffer,
    obj?: SetVisibleTimeInterval,
  ): SetVisibleTimeInterval {
  ...
  static createSetVisibleTimeInterval(
  ...
  unpack(): SetVisibleTimeIntervalT {
    return new SetVisibleTimeIntervalT(this.time() !== null ? this.time()!.unpack() : null);
  }
...
export class SetVisibleTimeIntervalT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SetVisibleTimeInterval.createSetVisibleTimeInterval(
      builder,
