...
export function unionToMethods(
  ...
  switch (Methods[type]) {
    case 'NONE':
      return null;
    case 'SetBid':
      return accessor(new SetBid())! as SetBid;
    case 'SetAsk':
      return accessor(new SetAsk())! as SetAsk;
    case 'SetEnabled':
      return accessor(new SetEnabled())! as SetEnabled;
    default:
      return null;
  }
}
...
export function unionListToMethods(
  ...
  switch (Methods[type]) {
    case 'NONE':
      return null;
    case 'SetBid':
      return accessor(index, new SetBid())! as SetBid;
    case 'SetAsk':
      return accessor(index, new SetAsk())! as SetAsk;
    case 'SetEnabled':
      return accessor(index, new SetEnabled())! as SetEnabled;
    default:
      return null;
  }
}
