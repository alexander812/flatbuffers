...
export class HideDirectionsAreas implements flatbuffers.IUnpackableObject<HideDirectionsAreasT> {
  ...
  static getSizePrefixedRootAsHideDirectionsAreas(
    bb: flatbuffers.ByteBuffer,
    obj?: HideDirectionsAreas,
  ): HideDirectionsAreas {
...
export class HideDirectionsAreasT implements flatbuffers.IGeneratedObject {
  constructor() {}
