...
export class FinishOnboardingDeal implements flatbuffers.IUnpackableObject<FinishOnboardingDealT> {
  ...
  static getSizePrefixedRootAsFinishOnboardingDeal(
    bb: flatbuffers.ByteBuffer,
    obj?: FinishOnboardingDeal,
  ...
  static createFinishOnboardingDeal(
    builder: flatbuffers.Builder,
    profitOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
  ...
  unpack(): FinishOnboardingDealT {
    return new FinishOnboardingDealT(this.profit());
  }
...
export class FinishOnboardingDealT implements flatbuffers.IGeneratedObject {
  constructor(public profit: string | Uint8Array | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const profit = this.profit !== null ? builder.createString(this.profit) : 0;

    return FinishOnboardingDeal.createFinishOnboardingDeal(builder, profit);
  }
}
