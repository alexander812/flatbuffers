...
import type { AdviserModelT } from '../../milky/model/adviser/adviser-model.js';
import { AdviserModel } from '../../milky/model/adviser/adviser-model.js';

export class AdviserSignal implements flatbuffers.IUnpackableObject<AdviserSignalT> {
...
export class AdviserSignalT implements flatbuffers.IGeneratedObject {
  constructor(public signal: AdviserModelT | null = null, public id: AdviserIdT | null = null) {}
