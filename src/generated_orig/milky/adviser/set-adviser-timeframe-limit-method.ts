...
export class SetAdviserTimeframeLimitMethod implements flatbuffers.IUnpackableObject<SetAdviserTimeframeLimitMethodT> {
  ...
  static getRootAsSetAdviserTimeframeLimitMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: SetAdviserTimeframeLimitMethod,
  ...
  static getSizePrefixedRootAsSetAdviserTimeframeLimitMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: SetAdviserTimeframeLimitMethod,
  ): SetAdviserTimeframeLimitMethod {
  ...
  static createSetAdviserTimeframeLimitMethod(
  ...
  unpack(): SetAdviserTimeframeLimitMethodT {
    return new SetAdviserTimeframeLimitMethodT(this.adviserTimeframeLimit(), this.isHighLimit());
  }
...
export class SetAdviserTimeframeLimitMethodT implements flatbuffers.IGeneratedObject {
  constructor(public adviserTimeframeLimit: number = 0, public isHighLimit: boolean = true) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SetAdviserTimeframeLimitMethod.createSetAdviserTimeframeLimitMethod(
      builder,
