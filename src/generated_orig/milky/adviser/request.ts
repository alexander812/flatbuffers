...
import type { AddAdviserMethodT } from '../../milky/adviser/add-adviser-method.js';
import { AddAdviserMethod } from '../../milky/adviser/add-adviser-method.js';
import { Methods, unionToMethods, unionListToMethods } from '../../milky/adviser/methods.js';
import type { RemoveAdviserMethodT } from '../../milky/adviser/remove-adviser-method.js';
import { RemoveAdviserMethod } from '../../milky/adviser/remove-adviser-method.js';
import type { SetAdviserTimeframeLimitMethodT } from '../../milky/adviser/set-adviser-timeframe-limit-method.js';
import { SetAdviserTimeframeLimitMethod } from '../../milky/adviser/set-adviser-timeframe-limit-method.js';
...
export class RequestT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: AddAdviserMethodT | RemoveAdviserMethodT | SetAdviserTimeframeLimitMethodT | null = null,
  ) {}
