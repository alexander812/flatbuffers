...
export function unionToAreaVariants(
  ...
  switch (AreaVariants[type]) {
    case 'NONE':
      return null;
    case 'ChartArea':
      return accessor(new ChartArea())! as ChartArea;
    case 'OscillatorArea':
      return accessor(new OscillatorArea())! as OscillatorArea;
    case 'TimeAxis':
      return accessor(new TimeAxis())! as TimeAxis;
    default:
      return null;
  }
}
...
export function unionListToAreaVariants(
  ...
  switch (AreaVariants[type]) {
    case 'NONE':
      return null;
    case 'ChartArea':
      return accessor(index, new ChartArea())! as ChartArea;
    case 'OscillatorArea':
      return accessor(index, new OscillatorArea())! as OscillatorArea;
    case 'TimeAxis':
      return accessor(index, new TimeAxis())! as TimeAxis;
    default:
      return null;
  }
}
