...
import { TooltipType } from '../../../milky/model/deal/tooltip-type.js';

export class TooltipProperties implements flatbuffers.IUnpackableObject<TooltipPropertiesT> {
  ...
  static getSizePrefixedRootAsTooltipProperties(
    bb: flatbuffers.ByteBuffer,
    obj?: TooltipProperties,
  ): TooltipProperties {
  ...
  static createTooltipProperties(
    builder: flatbuffers.Builder,
    type: TooltipType,
    labelTextOffset: flatbuffers.Offset,
    btnTextOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
  ...
  unpack(): TooltipPropertiesT {
    return new TooltipPropertiesT(this.type(), this.labelText(), this.btnText());
  }
...
export class TooltipPropertiesT implements flatbuffers.IGeneratedObject {
  constructor(
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return TooltipProperties.createTooltipProperties(builder, this.type, labelText, btnText);
  }
}
