...
export class NotificationLevelId implements flatbuffers.IUnpackableObject<NotificationLevelIdT> {
  ...
  static getSizePrefixedRootAsNotificationLevelId(
    bb: flatbuffers.ByteBuffer,
    obj?: NotificationLevelId,
  ): NotificationLevelId {
  ...
  unpack(): NotificationLevelIdT {
    return new NotificationLevelIdT(this.id());
  }
...
export class NotificationLevelIdT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return NotificationLevelId.createNotificationLevelId(builder, this.id);
  }
}
