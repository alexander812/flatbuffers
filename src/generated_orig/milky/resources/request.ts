...
import type { LoadTextureAtlasFromClientRequestT } from '../../milky/resources/load-texture-atlas-from-client-request.js';
import { LoadTextureAtlasFromClientRequest } from '../../milky/resources/load-texture-atlas-from-client-request.js';
import { Methods, unionToMethods, unionListToMethods } from '../../milky/resources/methods.js';
...
export class RequestT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: LoadTextureAtlasFromClientRequestT | null = null,
  ) {}
