...
export function unionToResourceRequest(
  ...
  switch (ResourceRequest[type]) {
    case 'NONE':
      return null;
    case 'StaticResource':
      return accessor(new StaticResource())! as StaticResource;
    case 'DynamicResource':
      return accessor(new DynamicResource())! as DynamicResource;
    default:
      return null;
  }
}
...
export function unionListToResourceRequest(
  ...
  switch (ResourceRequest[type]) {
    case 'NONE':
      return null;
    case 'StaticResource':
      return accessor(index, new StaticResource())! as StaticResource;
    case 'DynamicResource':
      return accessor(index, new DynamicResource())! as DynamicResource;
    default:
      return null;
  }
}
