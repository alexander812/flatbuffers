...
import { ReplyFromChart, unionToReplyFromChart, unionListToReplyFromChart } from '../milky/reply-from-chart.js';
import type { ReplyT } from '../milky/common/reply.js';
import { Reply } from '../milky/common/reply.js';
import type { ActiveIndicatorsIdsReplyT } from '../milky/indicator/active-indicators-ids-reply.js';
import { ActiveIndicatorsIdsReply } from '../milky/indicator/active-indicators-ids-reply.js';
import type { ReplyT as milky_layout_ReplyT } from '../milky/layout/reply.js';
import { Reply as milky_layout_Reply } from '../milky/layout/reply.js';
import type { ReplyT as milky_quotes_ReplyT } from '../milky/quotes/reply.js';
import { Reply as milky_quotes_Reply } from '../milky/quotes/reply.js';
import type { ReplyT as milky_version_ReplyT } from '../milky/version/reply.js';
import { Reply as milky_version_Reply } from '../milky/version/reply.js';

export class OutputFromChart implements flatbuffers.IUnpackableObject<OutputFromChartT> {
  ...
  unpack(): OutputFromChartT {
    return new OutputFromChartT(
      this.replyType(),
      (() => {
        const temp = unionToReplyFromChart(this.replyType(), this.reply.bind(this));
        if (temp === null) {
          return null;
        }
        return temp.unpack();
...
export class OutputFromChartT implements flatbuffers.IGeneratedObject {
  constructor(
    public replyType: ReplyFromChart = ReplyFromChart.NONE,
    public reply:
      | ActiveIndicatorsIdsReplyT
      | ReplyT
      | milky_layout_ReplyT
      | milky_quotes_ReplyT
      | milky_version_ReplyT
      | null = null,
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return OutputFromChart.createOutputFromChart(builder, this.replyType, reply, this.requestId, this.requestType);
  }
}
