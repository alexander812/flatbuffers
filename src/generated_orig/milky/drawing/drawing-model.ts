...
import type { PointT } from '../../milky/drawing/point.js';
import { Point } from '../../milky/drawing/point.js';
...
export class DrawingModel implements flatbuffers.IUnpackableObject<DrawingModelT> {
  ...
  unpack(): DrawingModelT {
    return new DrawingModelT(
      ...
      this.color(),
      this.lineWidth(),
      this.bb!.createObjList<Point, PointT>(this.points.bind(this), this.pointsLength()),
    );
  }
  ...
  unpackTo(_o: DrawingModelT): void {
    ...
    _o.points = this.bb!.createObjList<Point, PointT>(this.points.bind(this), this.pointsLength());
  }
}
...
export class DrawingModelT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return DrawingModel.createDrawingModel(builder, id, this.type, this.color, this.lineWidth, points);
  }
}
