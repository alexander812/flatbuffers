...
export class DrawingId implements flatbuffers.IUnpackableObject<DrawingIdT> {
  ...
  unpack(): DrawingIdT {
    return new DrawingIdT(this.value());
  }
...
export class DrawingIdT implements flatbuffers.IGeneratedObject {
  constructor(public value: bigint = BigInt('0')) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return DrawingId.createDrawingId(builder, this.value);
  }
}
