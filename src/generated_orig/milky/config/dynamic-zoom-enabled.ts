...
export class DynamicZoomEnabled implements flatbuffers.IUnpackableObject<DynamicZoomEnabledT> {
  ...
  static getSizePrefixedRootAsDynamicZoomEnabled(
    bb: flatbuffers.ByteBuffer,
    obj?: DynamicZoomEnabled,
  ): DynamicZoomEnabled {
  ...
  unpack(): DynamicZoomEnabledT {
    return new DynamicZoomEnabledT(this.enable());
  }
...
export class DynamicZoomEnabledT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return DynamicZoomEnabled.createDynamicZoomEnabled(builder, this.enable);
  }
}
