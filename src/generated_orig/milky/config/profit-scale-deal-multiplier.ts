...
export class ProfitScaleDealMultiplier implements flatbuffers.IUnpackableObject<ProfitScaleDealMultiplierT> {
  ...
  static getRootAsProfitScaleDealMultiplier(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealMultiplier,
  ): ProfitScaleDealMultiplier {
    return (obj || new ProfitScaleDealMultiplier()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsProfitScaleDealMultiplier(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealMultiplier,
  ): ProfitScaleDealMultiplier {
  ...
  unpack(): ProfitScaleDealMultiplierT {
    return new ProfitScaleDealMultiplierT(this.multiplier());
  }
...
export class ProfitScaleDealMultiplierT implements flatbuffers.IGeneratedObject {
  constructor(public multiplier: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return ProfitScaleDealMultiplier.createProfitScaleDealMultiplier(builder, this.multiplier);
  }
}
