...
export class Locale implements flatbuffers.IUnpackableObject<LocaleT> {
  ...
  unpack(): LocaleT {
    return new LocaleT(this.locale());
  }
...
export class LocaleT implements flatbuffers.IGeneratedObject {
  constructor(public locale: string | Uint8Array | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const locale = this.locale !== null ? builder.createString(this.locale) : 0;

    return Locale.createLocale(builder, locale);
  }
}
