...
export class SetServerTime implements flatbuffers.IUnpackableObject<SetServerTimeT> {
  ...
  unpack(): SetServerTimeT {
    return new SetServerTimeT(this.time() !== null ? this.time()!.unpack() : null);
  }
...
export class SetServerTimeT implements flatbuffers.IGeneratedObject {
  constructor(public time: TimeT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SetServerTime.createSetServerTime(builder, this.time !== null ? this.time.pack(builder) : 0);
  }
}
