...
export class NotifyCancelOrder implements flatbuffers.IUnpackableObject<NotifyCancelOrderT> {
  ...
  static getSizePrefixedRootAsNotifyCancelOrder(
    bb: flatbuffers.ByteBuffer,
    obj?: NotifyCancelOrder,
  ): NotifyCancelOrder {
  ...
  unpack(): NotifyCancelOrderT {
    return new NotifyCancelOrderT(this.id() !== null ? this.id()!.unpack() : null);
  }
...
export class NotifyCancelOrderT implements flatbuffers.IGeneratedObject {
  constructor(public id: DealIdT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return NotifyCancelOrder.createNotifyCancelOrder(builder, this.id !== null ? this.id.pack(builder) : 0);
  }
}
