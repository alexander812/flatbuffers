...
export class UpdateDeals implements flatbuffers.IUnpackableObject<UpdateDealsT> {
  ...
  unpack(): UpdateDealsT {
    return new UpdateDealsT(this.bb!.createObjList<DealModel, DealModelT>(this.deals.bind(this), this.dealsLength()));
  }
...
export class UpdateDealsT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return UpdateDeals.createUpdateDeals(builder, deals);
  }
}
