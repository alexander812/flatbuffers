...
export class AddTick implements flatbuffers.IUnpackableObject<AddTickT> {
  ...
  unpack(): AddTickT {
    return new AddTickT(this.tick() !== null ? this.tick()!.unpack() : null);
  }
...
export class AddTickT implements flatbuffers.IGeneratedObject {
  constructor(public tick: TickT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const tick = this.tick !== null ? this.tick.pack(builder) : 0;

    return AddTick.createAddTick(builder, tick);
  }
}
