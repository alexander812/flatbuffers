...
export class SetTimeFrame implements flatbuffers.IUnpackableObject<SetTimeFrameT> {
  ...
  unpack(): SetTimeFrameT {
    return new SetTimeFrameT(this.timeFrame());
  }
...
export class SetTimeFrameT implements flatbuffers.IGeneratedObject {
  constructor(public timeFrame: number = 0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SetTimeFrame.createSetTimeFrame(builder, this.timeFrame);
  }
}
