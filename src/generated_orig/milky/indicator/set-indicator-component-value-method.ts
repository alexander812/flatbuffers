...
import type { ValueT } from '../../milky/indicator/value.js';
import { Value } from '../../milky/indicator/value.js';
import type { IndicatorComponentIdT } from '../../milky/model/indicator/indicator-component-id.js';
import { IndicatorComponentId } from '../../milky/model/indicator/indicator-component-id.js';
...
export class SetIndicatorComponentValueMethod
  implements flatbuffers.IUnpackableObject<SetIndicatorComponentValueMethodT>
{
  ...
  static getRootAsSetIndicatorComponentValueMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: SetIndicatorComponentValueMethod,
  ...
  static getSizePrefixedRootAsSetIndicatorComponentValueMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: SetIndicatorComponentValueMethod,
  ): SetIndicatorComponentValueMethod {
  ...
  values(index: number, obj?: Value): Value | null {
    ...
    return offset
      ? (obj || new Value()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!)
      : null;
  }
  ...
  unpack(): SetIndicatorComponentValueMethodT {
    return new SetIndicatorComponentValueMethodT(
      ...
      this.bb!.createObjList<Value, ValueT>(this.values.bind(this), this.valuesLength()),
    );
  }
  ...
  unpackTo(_o: SetIndicatorComponentValueMethodT): void {
    ...
    _o.values = this.bb!.createObjList<Value, ValueT>(this.values.bind(this), this.valuesLength());
  }
}

export class SetIndicatorComponentValueMethodT implements flatbuffers.IGeneratedObject {
  constructor(
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const values = SetIndicatorComponentValueMethod.createValuesVector(
      builder,
      builder.createObjectOffsetList(this.values),
    );

    SetIndicatorComponentValueMethod.startSetIndicatorComponentValueMethod(builder);
    SetIndicatorComponentValueMethod.addIndicatorId(
      builder,
      this.indicatorId !== null ? this.indicatorId.pack(builder) : 0,
    );
    SetIndicatorComponentValueMethod.addComponentId(
      builder,
      this.componentId !== null ? this.componentId.pack(builder) : 0,
    );
