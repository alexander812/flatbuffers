...
export class RemoveIndicatorMethod implements flatbuffers.IUnpackableObject<RemoveIndicatorMethodT> {
  ...
  static getRootAsRemoveIndicatorMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: RemoveIndicatorMethod,
  ): RemoveIndicatorMethod {
    return (obj || new RemoveIndicatorMethod()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsRemoveIndicatorMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: RemoveIndicatorMethod,
  ): RemoveIndicatorMethod {
  ...
  static createRemoveIndicatorMethod(
  ...
  unpack(): RemoveIndicatorMethodT {
    return new RemoveIndicatorMethodT(this.indicatorId() !== null ? this.indicatorId()!.unpack() : null);
  }
...
export class RemoveIndicatorMethodT implements flatbuffers.IGeneratedObject {
  constructor(public indicatorId: IndicatorIdT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return RemoveIndicatorMethod.createRemoveIndicatorMethod(
      builder,
