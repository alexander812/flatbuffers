...
export function unionToNotifies(
  ...
  switch (Notifies[type]) {
    case 'NONE':
      return null;
    case 'OnStrikeSelected':
      return accessor(new OnStrikeSelected())! as OnStrikeSelected;
    case 'OnStrikeUnselected':
      return accessor(new OnStrikeUnselected())! as OnStrikeUnselected;
    default:
      return null;
  }
}
...
export function unionListToNotifies(
  ...
  switch (Notifies[type]) {
    case 'NONE':
      return null;
    case 'OnStrikeSelected':
      return accessor(index, new OnStrikeSelected())! as OnStrikeSelected;
    case 'OnStrikeUnselected':
      return accessor(index, new OnStrikeUnselected())! as OnStrikeUnselected;
    default:
      return null;
  }
}
