...
export class AddDealLimits implements flatbuffers.IUnpackableObject<AddDealLimitsT> {
  ...
  unpack(): AddDealLimitsT {
    return new AddDealLimitsT(this.limitModel() !== null ? this.limitModel()!.unpack() : null);
  }
...
export class AddDealLimitsT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return AddDealLimits.createAddDealLimits(builder, limitModel);
  }
}
