...
import type { DealLimitsT } from '../../milky/model/deal-limits/deal-limits.js';
import { DealLimits } from '../../milky/model/deal-limits/deal-limits.js';

export class UpdateDealLimits implements flatbuffers.IUnpackableObject<UpdateDealLimitsT> {
  ...
  static createUpdateDealLimits(
    builder: flatbuffers.Builder,
    limitModelOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
  ...
  unpack(): UpdateDealLimitsT {
    return new UpdateDealLimitsT(this.limitModel() !== null ? this.limitModel()!.unpack() : null);
  }
...
export class UpdateDealLimitsT implements flatbuffers.IGeneratedObject {
  constructor(public limitModel: DealLimitsT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const limitModel = this.limitModel !== null ? this.limitModel.pack(builder) : 0;

    return UpdateDealLimits.createUpdateDealLimits(builder, limitModel);
  }
}
