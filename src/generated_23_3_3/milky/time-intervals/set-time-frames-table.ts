...
import { TimeFrame, TimeFrameT } from '../../milky/time-intervals/time-frame.js';
...
unpackTo(_o: SetTimeFramesTableT): void {
  _o.timeFrameTable = this.bb!.createObjList<TimeFrame, TimeFrameT>(this.timeFrameTable.bind(this), this.timeFrameTableLength());
}
}
