...
import { Resource, ResourceT } from '../../milky/resources/resource.js';


export class LoadTextureAtlasFromClientRequest implements flatbuffers.IUnpackableObject<LoadTextureAtlasFromClientRequestT> {
...
static getRootAsLoadTextureAtlasFromClientRequest(bb:flatbuffers.ByteBuffer, obj?:LoadTextureAtlasFromClientRequest):LoadTextureAtlasFromClientRequest {
  return (obj || new LoadTextureAtlasFromClientRequest()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLoadTextureAtlasFromClientRequest(bb:flatbuffers.ByteBuffer, obj?:LoadTextureAtlasFromClientRequest):LoadTextureAtlasFromClientRequest {
