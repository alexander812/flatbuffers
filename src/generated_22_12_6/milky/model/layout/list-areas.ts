...
import { AreaInfo, AreaInfoT } from '../../../milky/model/layout/area-info.js';
...
data(index: number, obj?:AreaInfo):AreaInfo|null {
  ...
  return offset ? (obj || new AreaInfo()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
unpack(): ListAreasT {
  return new ListAreasT(
    this.bb!.createObjList<AreaInfo, AreaInfoT>(this.data.bind(this), this.dataLength())
  );
}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ListAreas.createListAreas(builder,
    data
  );
}
}
