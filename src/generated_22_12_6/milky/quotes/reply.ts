...
import { Error, ErrorT } from '../../milky/quotes/error.js';
...
static createReply(builder:flatbuffers.Builder, replyType:QuotesReplys, replyOffset:flatbuffers.Offset):flatbuffers.Offset {
...
constructor(
  public replyType: QuotesReplys = QuotesReplys.NONE,
