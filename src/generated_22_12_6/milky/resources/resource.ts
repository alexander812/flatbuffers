...
static createResource(builder:flatbuffers.Builder, dataOffset:flatbuffers.Offset, typeOffset:flatbuffers.Offset):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Resource.createResource(builder,
    data,
    type
  );
}
