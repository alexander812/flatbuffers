...
import { DrawingModel3, DrawingModel3T } from '../../milky/drawing/drawing-model3.js';


export class EditedDrawingNotify3 implements flatbuffers.IUnpackableObject<EditedDrawingNotify3T> {
...
export class EditedDrawingNotify3T implements flatbuffers.IGeneratedObject {
constructor(
