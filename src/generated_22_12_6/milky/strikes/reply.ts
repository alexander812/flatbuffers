...
import { StrikesReplys, unionToStrikesReplys, unionListToStrikesReplys } from '../../milky/strikes/strikes-replys.js';
...
replyType():StrikesReplys {
  const offset = this.bb!.__offset(this.bb_pos, 4);
  return offset ? this.bb!.readUint8(this.bb_pos + offset) : StrikesReplys.NONE;
}
...
static addReplyType(builder:flatbuffers.Builder, replyType:StrikesReplys) {
  builder.addFieldInt8(0, replyType, StrikesReplys.NONE);
}
...
static createReply(builder:flatbuffers.Builder, replyType:StrikesReplys, replyOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): ReplyT {
  return new ReplyT(
    this.replyType(),
    (() => {
      const temp = unionToStrikesReplys(this.replyType(), this.reply.bind(this));
...
constructor(
  public replyType: StrikesReplys = StrikesReplys.NONE,
