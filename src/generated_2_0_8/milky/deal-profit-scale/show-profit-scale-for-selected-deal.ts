...
import { DealProfitScale, DealProfitScaleT } from '../../milky/model/deal-profit-scale/deal-profit-scale';


export class ShowProfitScaleForSelectedDeal {
...
export class ShowProfitScaleForSelectedDealT {
constructor(
