...
import { BaseAnimation, BaseAnimationT } from '../../milky/animations/base-animation';
import { VerticalAnimationDirection } from '../../milky/animations/vertical-animation-direction';
...
static createLabelAnimation(builder:flatbuffers.Builder, baseModelOffset:flatbuffers.Offset, verticalDirection:VerticalAnimationDirection):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LabelAnimation.createLabelAnimation(builder,
    baseModel,
    this.verticalDirection
  );
}
