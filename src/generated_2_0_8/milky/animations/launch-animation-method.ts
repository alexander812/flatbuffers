...
import { Animations, unionToAnimations, unionListToAnimations } from '../../milky/animations/animations';
import { LabelAnimation, LabelAnimationT } from '../../milky/animations/label-animation';
import { SplashAnimation, SplashAnimationT } from '../../milky/animations/splash-animation';


export class LaunchAnimationMethod {
...
unpack(): LaunchAnimationMethodT {
  return new LaunchAnimationMethodT(
    ...
    (() => {
      let temp = unionToAnimations(this.animationModelType(), this.animationModel.bind(this));
...
export class LaunchAnimationMethodT {
constructor(
