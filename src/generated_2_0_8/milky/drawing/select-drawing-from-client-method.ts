...
export class SelectDrawingFromClientMethod {
...
static getRootAsSelectDrawingFromClientMethod(bb:flatbuffers.ByteBuffer, obj?:SelectDrawingFromClientMethod):SelectDrawingFromClientMethod {
  return (obj || new SelectDrawingFromClientMethod()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSelectDrawingFromClientMethod(bb:flatbuffers.ByteBuffer, obj?:SelectDrawingFromClientMethod):SelectDrawingFromClientMethod {
...
static createSelectDrawingFromClientMethod(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): SelectDrawingFromClientMethodT {
  return new SelectDrawingFromClientMethodT(
...
export class SelectDrawingFromClientMethodT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return SelectDrawingFromClientMethod.createSelectDrawingFromClientMethod(builder,
    id
  );
}
}
