...
export class GetActiveIndicatorsIdsMethod {
...
static getRootAsGetActiveIndicatorsIdsMethod(bb:flatbuffers.ByteBuffer, obj?:GetActiveIndicatorsIdsMethod):GetActiveIndicatorsIdsMethod {
  return (obj || new GetActiveIndicatorsIdsMethod()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsGetActiveIndicatorsIdsMethod(bb:flatbuffers.ByteBuffer, obj?:GetActiveIndicatorsIdsMethod):GetActiveIndicatorsIdsMethod {
...
export class GetActiveIndicatorsIdsMethodT {
constructor(){}
