...
import { IndicatorType } from '../../milky/model/indicator/indicator-type';


export class AddIndicatorMethod {
...
static getSizePrefixedRootAsAddIndicatorMethod(bb:flatbuffers.ByteBuffer, obj?:AddIndicatorMethod):AddIndicatorMethod {
...
static createAddIndicatorMethod(builder:flatbuffers.Builder, indicatorIdOffset:flatbuffers.Offset, type:IndicatorType):flatbuffers.Offset {
...
unpack(): AddIndicatorMethodT {
  return new AddIndicatorMethodT(
...
export class AddIndicatorMethodT {
constructor(
  public indicatorId: IndicatorIdT|null = null,
  public type: IndicatorType = IndicatorType.Undefined
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return AddIndicatorMethod.createAddIndicatorMethod(builder,
