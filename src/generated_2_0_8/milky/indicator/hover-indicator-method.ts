...
export class HoverIndicatorMethod {
...
static getSizePrefixedRootAsHoverIndicatorMethod(bb:flatbuffers.ByteBuffer, obj?:HoverIndicatorMethod):HoverIndicatorMethod {
...
static createHoverIndicatorMethod(builder:flatbuffers.Builder, indicatorIdOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): HoverIndicatorMethodT {
  return new HoverIndicatorMethodT(
...
export class HoverIndicatorMethodT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return HoverIndicatorMethod.createHoverIndicatorMethod(builder,
