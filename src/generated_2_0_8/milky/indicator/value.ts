...
import { Active, ActiveT } from '../../milky/indicator/active';
import { Color, ColorT } from '../../milky/indicator/color';
import { Opacity, OpacityT } from '../../milky/indicator/opacity';
import { Periods, PeriodsT } from '../../milky/indicator/periods';
import { Style, StyleT } from '../../milky/indicator/style';
import { Type, TypeT } from '../../milky/indicator/type';
import { ValuesType, unionToValuesType, unionListToValuesType } from '../../milky/indicator/values-type';
import { Width, WidthT } from '../../milky/indicator/width';
...
static createValue(builder:flatbuffers.Builder, valueType:ValuesType, valueOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): ValueT {
  return new ValueT(
    this.valueType(),
    (() => {
      let temp = unionToValuesType(this.valueType(), this.value.bind(this));
