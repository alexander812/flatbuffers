...
import { RequestFromChart, unionToRequestFromChart, unionListToRequestFromChart } from '../milky/request-from-chart';
...
unpack(): InputFromChartT {
  return new InputFromChartT(
    this.requestType(),
    (() => {
      let temp = unionToRequestFromChart(this.requestType(), this.request.bind(this));
