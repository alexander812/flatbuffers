...
import { MessageType, unionToMessageType, unionListToMessageType } from '../milky/message-type';
...
static createMessage(builder:flatbuffers.Builder, contentType:MessageType, contentOffset:flatbuffers.Offset):flatbuffers.Offset {
...
unpack(): MessageT {
  return new MessageT(
    this.contentType(),
    (() => {
      let temp = unionToMessageType(this.contentType(), this.content.bind(this));
