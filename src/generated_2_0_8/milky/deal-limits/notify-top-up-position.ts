...
export class NotifyTopUpPosition {
...
static getSizePrefixedRootAsNotifyTopUpPosition(bb:flatbuffers.ByteBuffer, obj?:NotifyTopUpPosition):NotifyTopUpPosition {
...
unpack(): NotifyTopUpPositionT {
  return new NotifyTopUpPositionT(
    this.positionY()
  );
}
...
export class NotifyTopUpPositionT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return NotifyTopUpPosition.createNotifyTopUpPosition(builder,
    this.positionY
  );
}
}
