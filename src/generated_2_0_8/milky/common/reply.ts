...
import { CommonReplies, unionToCommonReplies, unionListToCommonReplies } from '../../milky/common/common-replies';
import { Error, ErrorT } from '../../milky/common/error';
import { Ok, OkT } from '../../milky/common/ok';
import { Unimplemented, UnimplementedT } from '../../milky/common/unimplemented';
...
unpack(): ReplyT {
  return new ReplyT(
    this.resultType(),
    (() => {
      let temp = unionToCommonReplies(this.resultType(), this.result.bind(this));
