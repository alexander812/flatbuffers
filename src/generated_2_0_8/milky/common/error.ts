...
import { ErrorCode } from '../../milky/common/error-code';
...
static createError(builder:flatbuffers.Builder, descriptionOffset:flatbuffers.Offset, code:ErrorCode):flatbuffers.Offset {
...
constructor(
  ...
  public code: ErrorCode = ErrorCode.UnknownError
){}
