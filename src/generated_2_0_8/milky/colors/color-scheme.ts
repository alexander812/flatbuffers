...
import { ColorTable, ColorTableT } from '../../milky/colors/color-table';
...
static createColorScheme(builder:flatbuffers.Builder, colorTableOffset:flatbuffers.Offset, borderEnabled:boolean):flatbuffers.Offset {
...
unpack(): ColorSchemeT {
  return new ColorSchemeT(
    (this.colorTable() !== null ? this.colorTable()!.unpack() : null),
    this.borderEnabled()
  );
}
...
export class ColorSchemeT {
constructor(
  public colorTable: ColorTableT|null = null,
  public borderEnabled: boolean = false
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return ColorScheme.createColorScheme(builder,
    colorTable,
    this.borderEnabled
  );
}
