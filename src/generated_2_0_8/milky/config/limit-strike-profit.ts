...
export class LimitStrikeProfit {
...
static getSizePrefixedRootAsLimitStrikeProfit(bb:flatbuffers.ByteBuffer, obj?:LimitStrikeProfit):LimitStrikeProfit {
...
export class LimitStrikeProfitT {
constructor(
  public up: number = 0,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return LimitStrikeProfit.createLimitStrikeProfit(builder,
    this.up,
    this.down
  );
}
