...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return DealDuration.createDealDuration(builder,
    (this.duration !== null ? this.duration!.pack(builder) : 0)
  );
}
}
