...
export class OptionProfitUpValue {
...
static getSizePrefixedRootAsOptionProfitUpValue(bb:flatbuffers.ByteBuffer, obj?:OptionProfitUpValue):OptionProfitUpValue {
...
unpack(): OptionProfitUpValueT {
  return new OptionProfitUpValueT(
    this.value()
  );
}
...
export class OptionProfitUpValueT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return OptionProfitUpValue.createOptionProfitUpValue(builder,
    this.value
  );
}
}
