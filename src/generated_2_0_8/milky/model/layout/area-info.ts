...
import { AreaVariants, unionToAreaVariants, unionListToAreaVariants } from '../../../milky/model/layout/area-variants';
import { ChartArea, ChartAreaT } from '../../../milky/model/layout/chart-area';
import { OscillatorArea, OscillatorAreaT } from '../../../milky/model/layout/oscillator-area';
import { TimeAxis, TimeAxisT } from '../../../milky/model/layout/time-axis';
...
unpack(): AreaInfoT {
  return new AreaInfoT(
    this.infoType(),
    (() => {
      let temp = unionToAreaVariants(this.infoType(), this.info.bind(this));
