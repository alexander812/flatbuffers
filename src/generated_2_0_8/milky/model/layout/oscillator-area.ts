...
static createOscillatorArea(builder:flatbuffers.Builder, indicatorIdOffset:flatbuffers.Offset, indicatorType:IndicatorType, quoteAxisWidth:number):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return OscillatorArea.createOscillatorArea(builder,
