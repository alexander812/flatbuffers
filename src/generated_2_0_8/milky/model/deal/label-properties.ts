...
import { LabelDirection } from '../../../milky/model/deal/label-direction';
import { LabelLayout } from '../../../milky/model/deal/label-layout';
import { LabelShape } from '../../../milky/model/deal/label-shape';
import { LabelType } from '../../../milky/model/deal/label-type';
import { ShowUpAnimation } from '../../../milky/model/deal/show-up-animation';
...
type():LabelType {
  ...
  return offset ? this.bb!.readInt32(this.bb_pos + offset) : LabelType.Amount;
}
...
static addType(builder:flatbuffers.Builder, type:LabelType) {
  builder.addFieldInt32(0, type, LabelType.Amount);
}
...
static addHasBorder(builder:flatbuffers.Builder, hasBorder:boolean) {
  builder.addFieldInt8(7, +hasBorder, +false);
}

static addFillOpacity(builder:flatbuffers.Builder, fillOpacity:number) {
  builder.addFieldFloat32(8, fillOpacity, 1.0);
}
...
static createLabelProperties(builder:flatbuffers.Builder, type:LabelType, shape:LabelShape, direction:LabelDirection, textOffset:flatbuffers.Offset, layout:LabelLayout, animation:ShowUpAnimation, imgId:number, hasBorder:boolean, fillOpacity:number):flatbuffers.Offset {
  ...
  LabelProperties.addHasBorder(builder, hasBorder);
  LabelProperties.addFillOpacity(builder, fillOpacity);
...
unpackTo(_o: LabelPropertiesT): void {
  ...
  _o.fillOpacity = this.fillOpacity();
}
}

export class LabelPropertiesT {
constructor(
  public type: LabelType = LabelType.Amount,
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return LabelProperties.createLabelProperties(builder,
    this.type,
    this.shape,
    this.direction,
    text,
