...
import { StaticResourceType } from '../../milky/resources/static-resource-type';
...
export class StaticResourceT {
constructor(
  public id: StaticResourceType = StaticResourceType.Undefined
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return StaticResource.createStaticResource(builder,
    this.id
  );
}
}
