...
import { ResourceRequest, unionToResourceRequest, unionListToResourceRequest } from '../../milky/resources/resource-request';
...
unpack(): NotifyT {
  return new NotifyT(
    this.requestType(),
    (() => {
      let temp = unionToResourceRequest(this.requestType(), this.request.bind(this));
