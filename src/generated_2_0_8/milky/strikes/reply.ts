...
import { Error, ErrorT } from '../../milky/strikes/error';
import { StrikesReplys, unionToStrikesReplys, unionListToStrikesReplys } from '../../milky/strikes/strikes-replys';
...
unpack(): ReplyT {
  return new ReplyT(
    this.replyType(),
    (() => {
      let temp = unionToStrikesReplys(this.replyType(), this.reply.bind(this));
