...
import { Strike, StrikeT } from '../../milky/model/strike/strike';
...
unpack(): SetStrikesT {
  return new SetStrikesT(
    this.bb!.createObjList(this.strikes.bind(this), this.strikesLength())
  );
}


unpackTo(_o: SetStrikesT): void {
  _o.strikes = this.bb!.createObjList(this.strikes.bind(this), this.strikesLength());
}
}

export class SetStrikesT {
constructor(
