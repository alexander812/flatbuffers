...
unpack(): RemoveAllDealsT {
  return new RemoveAllDealsT(
    this.bb!.createScalarList(this.types.bind(this), this.typesLength())
  );
}


unpackTo(_o: RemoveAllDealsT): void {
  _o.types = this.bb!.createScalarList(this.types.bind(this), this.typesLength());
}
}

export class RemoveAllDealsT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return RemoveAllDeals.createRemoveAllDeals(builder,
    types
  );
}
}
