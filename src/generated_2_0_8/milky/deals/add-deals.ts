...
import { DealModel, DealModelT } from '../../milky/model/deal/deal-model';
...
unpack(): AddDealsT {
  return new AddDealsT(
    this.bb!.createObjList(this.deals.bind(this), this.dealsLength())
  );
}


unpackTo(_o: AddDealsT): void {
  _o.deals = this.bb!.createObjList(this.deals.bind(this), this.dealsLength());
}
}

export class AddDealsT {
constructor(
