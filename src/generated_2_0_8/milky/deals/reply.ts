...
import { DealsReplys, unionToDealsReplys, unionListToDealsReplys } from '../../milky/deals/deals-replys';
...
unpack(): ReplyT {
  return new ReplyT(
    this.replyType(),
    (() => {
      let temp = unionToDealsReplys(this.replyType(), this.reply.bind(this));
