...
export class SetStartPositionTime {
...
static getSizePrefixedRootAsSetStartPositionTime(bb:flatbuffers.ByteBuffer, obj?:SetStartPositionTime):SetStartPositionTime {
...
unpack(): SetStartPositionTimeT {
  return new SetStartPositionTimeT(
...
export class SetStartPositionTimeT {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return SetStartPositionTime.createSetStartPositionTime(builder,
