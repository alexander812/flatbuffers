...
export class SetAreaChartZoomLimits {
...
static getRootAsSetAreaChartZoomLimits(bb:flatbuffers.ByteBuffer, obj?:SetAreaChartZoomLimits):SetAreaChartZoomLimits {
  return (obj || new SetAreaChartZoomLimits()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsSetAreaChartZoomLimits(bb:flatbuffers.ByteBuffer, obj?:SetAreaChartZoomLimits):SetAreaChartZoomLimits {
...
static createSetAreaChartZoomLimits(builder:flatbuffers.Builder, minTimeInterval:number, maxTimeInterval:number):flatbuffers.Offset {
...
unpack(): SetAreaChartZoomLimitsT {
  return new SetAreaChartZoomLimitsT(
...
export class SetAreaChartZoomLimitsT {
constructor(
  public minTimeInterval: number = 0,
  public maxTimeInterval: number = 0
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return SetAreaChartZoomLimits.createSetAreaChartZoomLimits(builder,
    this.minTimeInterval,
    this.maxTimeInterval
  );
}
