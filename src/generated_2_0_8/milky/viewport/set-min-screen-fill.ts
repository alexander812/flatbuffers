...
unpack(): SetMinScreenFillT {
  return new SetMinScreenFillT(
    this.minimalScreenFeelRate()
  );
}
...
export class SetMinScreenFillT {
constructor(
  public minimalScreenFeelRate: number = 0.0
){}


pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return SetMinScreenFill.createSetMinScreenFill(builder,
    this.minimalScreenFeelRate
  );
}
}
