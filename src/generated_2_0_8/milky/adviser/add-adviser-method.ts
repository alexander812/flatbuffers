...
import { AdviserType } from '../../milky/adviser/adviser-type';
import { AdviserId, AdviserIdT } from '../../milky/model/adviser/adviser-id';


export class AddAdviserMethod {
...
static createAddAdviserMethod(builder:flatbuffers.Builder, idOffset:flatbuffers.Offset, type:AdviserType):flatbuffers.Offset {
...
export class AddAdviserMethodT {
constructor(
  public id: AdviserIdT|null = null,
  public type: AdviserType = AdviserType.Undefined
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return AddAdviserMethod.createAddAdviserMethod(builder,
    id,
    this.type
  );
}
