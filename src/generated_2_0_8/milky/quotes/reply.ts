...
import { Error, ErrorT } from '../../milky/quotes/error';
import { QuotesReplys, unionToQuotesReplys, unionListToQuotesReplys } from '../../milky/quotes/quotes-replys';
...
unpack(): ReplyT {
  return new ReplyT(
    this.replyType(),
    (() => {
      let temp = unionToQuotesReplys(this.replyType(), this.reply.bind(this));
