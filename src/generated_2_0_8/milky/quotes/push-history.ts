...
import { QuotesHistory, QuotesHistoryT } from '../../milky/model/quotes/quotes-history';
...
export class PushHistoryT {
constructor(
  public history: QuotesHistoryT|null = null
){}
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PushHistory.createPushHistory(builder,
    history
  );
}
}
