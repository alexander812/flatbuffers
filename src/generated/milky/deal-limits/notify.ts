...
import { Notifies, unionToNotifies, unionListToNotifies } from '../../milky/deal-limits/notifies.js';
import type { NotifyEditLimitT } from '../../milky/deal-limits/notify-edit-limit.js';
import { NotifyEditLimit } from '../../milky/deal-limits/notify-edit-limit.js';
import type { NotifyTopUpT } from '../../milky/deal-limits/notify-top-up.js';
import { NotifyTopUp } from '../../milky/deal-limits/notify-top-up.js';
import type { NotifyTopUpPositionT } from '../../milky/deal-limits/notify-top-up-position.js';
import { NotifyTopUpPosition } from '../../milky/deal-limits/notify-top-up-position.js';
...
export class NotifyT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: NotifyEditLimitT | NotifyTopUpPositionT | NotifyTopUpT | null = null,
  ) {}
