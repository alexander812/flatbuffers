...
export class ChangeHorizontalZoomBy implements flatbuffers.IUnpackableObject<ChangeHorizontalZoomByT> {
  ...
  static getRootAsChangeHorizontalZoomBy(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeHorizontalZoomBy,
  ): ChangeHorizontalZoomBy {
    return (obj || new ChangeHorizontalZoomBy()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsChangeHorizontalZoomBy(
    bb: flatbuffers.ByteBuffer,
    obj?: ChangeHorizontalZoomBy,
  ): ChangeHorizontalZoomBy {
  ...
  unpack(): ChangeHorizontalZoomByT {
    return new ChangeHorizontalZoomByT(this.delta());
  }
...
export class ChangeHorizontalZoomByT implements flatbuffers.IGeneratedObject {
  constructor(public delta: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return ChangeHorizontalZoomBy.createChangeHorizontalZoomBy(builder, this.delta);
  }
}
