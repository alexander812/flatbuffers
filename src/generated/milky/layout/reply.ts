...
import { ResultsReply, unionToResultsReply, unionListToResultsReply } from '../../milky/layout/results-reply.js';
import type { ListAreasT } from '../../milky/model/layout/list-areas.js';
import { ListAreas } from '../../milky/model/layout/list-areas.js';
...
export class ReplyT implements flatbuffers.IGeneratedObject {
  constructor(public resultType: ResultsReply = ResultsReply.NONE, public result: ErrorT | ListAreasT | null = null) {}
