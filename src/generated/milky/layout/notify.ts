...
import { Notifies, unionToNotifies, unionListToNotifies } from '../../milky/layout/notifies.js';
...
export class NotifyT implements flatbuffers.IGeneratedObject {
  constructor(public methodType: Notifies = Notifies.NONE, public method: ListAreasT | null = null) {}
