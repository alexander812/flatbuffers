...
import type { ClearDataT } from '../../milky/common-requests/clear-data.js';
import { ClearData } from '../../milky/common-requests/clear-data.js';
import { Methods, unionToMethods, unionListToMethods } from '../../milky/common-requests/methods.js';
import type { ReloadFontsT } from '../../milky/common-requests/reload-fonts.js';
import { ReloadFonts } from '../../milky/common-requests/reload-fonts.js';
import type { ResetTextureAtlasT } from '../../milky/common-requests/reset-texture-atlas.js';
import { ResetTextureAtlas } from '../../milky/common-requests/reset-texture-atlas.js';
import type { SetServerTimeT } from '../../milky/common-requests/set-server-time.js';
import { SetServerTime } from '../../milky/common-requests/set-server-time.js';
...
export class RequestT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: ClearDataT | ReloadFontsT | ResetTextureAtlasT | SetServerTimeT | null = null,
  ) {}
