...
export class UpdateCandle implements flatbuffers.IUnpackableObject<UpdateCandleT> {
  ...
  unpack(): UpdateCandleT {
    return new UpdateCandleT(this.candle() !== null ? this.candle()!.unpack() : null);
  }
...
export class UpdateCandleT implements flatbuffers.IGeneratedObject {
  constructor(public candle: CandleT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const candle = this.candle !== null ? this.candle.pack(builder) : 0;

    return UpdateCandle.createUpdateCandle(builder, candle);
  }
}
