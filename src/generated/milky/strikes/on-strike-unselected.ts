...
export class OnStrikeUnselected implements flatbuffers.IUnpackableObject<OnStrikeUnselectedT> {
  ...
  static getSizePrefixedRootAsOnStrikeUnselected(
    bb: flatbuffers.ByteBuffer,
    obj?: OnStrikeUnselected,
  ): OnStrikeUnselected {
  ...
  unpack(): OnStrikeUnselectedT {
    return new OnStrikeUnselectedT(this.id() !== null ? this.id()!.unpack() : null);
  }
...
export class OnStrikeUnselectedT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return OnStrikeUnselected.createOnStrikeUnselected(builder, id);
  }
}
