...
import type { StrikeT } from '../../milky/model/strike/strike.js';
import { Strike } from '../../milky/model/strike/strike.js';
...
export class SetStrikes implements flatbuffers.IUnpackableObject<SetStrikesT> {
  ...
  strikes(index: number, obj?: Strike): Strike | null {
    ...
    return offset
      ? (obj || new Strike()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!)
      : null;
  }
  ...
  unpack(): SetStrikesT {
    return new SetStrikesT(this.bb!.createObjList<Strike, StrikeT>(this.strikes.bind(this), this.strikesLength()));
  }
