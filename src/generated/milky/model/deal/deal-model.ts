...
import type { AmountT } from '../../../milky/model/amount.js';
import { Amount } from '../../../milky/model/amount.js';
...
import type { LabelPropertiesT } from '../../../milky/model/deal/label-properties.js';
import { LabelProperties } from '../../../milky/model/deal/label-properties.js';
import { ProgressBarType } from '../../../milky/model/deal/progress-bar-type.js';
import type { TooltipPropertiesT } from '../../../milky/model/deal/tooltip-properties.js';
import { TooltipProperties } from '../../../milky/model/deal/tooltip-properties.js';
...
export class DealModel implements flatbuffers.IUnpackableObject<DealModelT> {
  ...
  labelsProperties(index: number, obj?: LabelProperties): LabelProperties | null {
    ...
    return offset
      ? (obj || new LabelProperties()).__init(
  ...
  unpack(): DealModelT {
    return new DealModelT(
      ...
      this.bb!.createObjList<LabelProperties, LabelPropertiesT>(
        this.labelsProperties.bind(this),
        this.labelsPropertiesLength(),
      ),
  ...
  unpackTo(_o: DealModelT): void {
    ...
    _o.labelsProperties = this.bb!.createObjList<LabelProperties, LabelPropertiesT>(
      this.labelsProperties.bind(this),
      this.labelsPropertiesLength(),
    );
...
export class DealModelT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const labelsProperties = DealModel.createLabelsPropertiesVector(
      builder,
      builder.createObjectOffsetList(this.labelsProperties),
    );
