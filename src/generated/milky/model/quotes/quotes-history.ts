...
import type { TickT } from '../../../milky/model/quotes/tick.js';
import { Tick } from '../../../milky/model/quotes/tick.js';

export class QuotesHistory implements flatbuffers.IUnpackableObject<QuotesHistoryT> {
  ...
  candles(index: number, obj?: Candle): Candle | null {
    ...
    return offset
      ? (obj || new Candle()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!)
      : null;
  }
  ...
  ticks(index: number, obj?: Tick): Tick | null {
    ...
    return offset
      ? (obj || new Tick()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!)
      : null;
  }
  ...
  unpack(): QuotesHistoryT {
    return new QuotesHistoryT(
      this.bb!.createObjList<Candle, CandleT>(this.candles.bind(this), this.candlesLength()),
      this.bb!.createObjList<Tick, TickT>(this.ticks.bind(this), this.ticksLength()),
  ...
  unpackTo(_o: QuotesHistoryT): void {
    _o.candles = this.bb!.createObjList<Candle, CandleT>(this.candles.bind(this), this.candlesLength());
    _o.ticks = this.bb!.createObjList<Tick, TickT>(this.ticks.bind(this), this.ticksLength());
...
export class QuotesHistoryT implements flatbuffers.IGeneratedObject {
  constructor(
