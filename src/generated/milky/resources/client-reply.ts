...
export class ClientReply implements flatbuffers.IUnpackableObject<ClientReplyT> {
  ...
  unpack(): ClientReplyT {
    return new ClientReplyT(this.resource() !== null ? this.resource()!.unpack() : null);
  }
...
export class ClientReplyT implements flatbuffers.IGeneratedObject {
  constructor(public resource: ResourceT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const resource = this.resource !== null ? this.resource.pack(builder) : 0;

    return ClientReply.createClientReply(builder, resource);
  }
}
