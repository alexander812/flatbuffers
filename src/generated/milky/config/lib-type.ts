...
import { LibTypeValues } from '../../milky/config/lib-type-values.js';

export class LibType implements flatbuffers.IUnpackableObject<LibTypeT> {
  ...
  unpack(): LibTypeT {
    return new LibTypeT(this.libType());
  }
...
export class LibTypeT implements flatbuffers.IGeneratedObject {
  constructor(public libType: LibTypeValues = LibTypeValues.Forex) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return LibType.createLibType(builder, this.libType);
  }
}
