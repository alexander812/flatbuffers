...
export class ProfitScaleDealAmount implements flatbuffers.IUnpackableObject<ProfitScaleDealAmountT> {
  ...
  static getRootAsProfitScaleDealAmount(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealAmount,
  ): ProfitScaleDealAmount {
    return (obj || new ProfitScaleDealAmount()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsProfitScaleDealAmount(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealAmount,
  ): ProfitScaleDealAmount {
  ...
  unpack(): ProfitScaleDealAmountT {
    return new ProfitScaleDealAmountT(this.amount());
  }
...
export class ProfitScaleDealAmountT implements flatbuffers.IGeneratedObject {
  constructor(public amount: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return ProfitScaleDealAmount.createProfitScaleDealAmount(builder, this.amount);
  }
}
