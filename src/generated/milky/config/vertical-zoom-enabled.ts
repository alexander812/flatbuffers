...
export class VerticalZoomEnabled implements flatbuffers.IUnpackableObject<VerticalZoomEnabledT> {
  ...
  static getSizePrefixedRootAsVerticalZoomEnabled(
    bb: flatbuffers.ByteBuffer,
    obj?: VerticalZoomEnabled,
  ): VerticalZoomEnabled {
  ...
  unpack(): VerticalZoomEnabledT {
    return new VerticalZoomEnabledT(this.enable());
  }
...
export class VerticalZoomEnabledT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return VerticalZoomEnabled.createVerticalZoomEnabled(builder, this.enable);
  }
}
