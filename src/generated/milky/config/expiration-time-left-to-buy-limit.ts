...
export class ExpirationTimeLeftToBuyLimit implements flatbuffers.IUnpackableObject<ExpirationTimeLeftToBuyLimitT> {
  ...
  static getRootAsExpirationTimeLeftToBuyLimit(
    bb: flatbuffers.ByteBuffer,
    obj?: ExpirationTimeLeftToBuyLimit,
  ): ExpirationTimeLeftToBuyLimit {
    return (obj || new ExpirationTimeLeftToBuyLimit()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsExpirationTimeLeftToBuyLimit(
    bb: flatbuffers.ByteBuffer,
    obj?: ExpirationTimeLeftToBuyLimit,
  ): ExpirationTimeLeftToBuyLimit {
  ...
  unpack(): ExpirationTimeLeftToBuyLimitT {
    return new ExpirationTimeLeftToBuyLimitT(this.leftToClose());
  }
...
export class ExpirationTimeLeftToBuyLimitT implements flatbuffers.IGeneratedObject {
  constructor(public leftToClose: number = 0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return ExpirationTimeLeftToBuyLimit.createExpirationTimeLeftToBuyLimit(builder, this.leftToClose);
  }
}
