...
export class SentimentValue implements flatbuffers.IUnpackableObject<SentimentValueT> {
  ...
  unpack(): SentimentValueT {
    return new SentimentValueT(this.value());
  }
...
export class SentimentValueT implements flatbuffers.IGeneratedObject {
  constructor(public value: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SentimentValue.createSentimentValue(builder, this.value);
  }
}
