...
import { ChartStatus } from '../../milky/config/chart-status.js';

export class SetChartStatus implements flatbuffers.IUnpackableObject<SetChartStatusT> {
  ...
  unpack(): SetChartStatusT {
    return new SetChartStatusT(this.chartStatus());
  }
...
export class SetChartStatusT implements flatbuffers.IGeneratedObject {
  constructor(public chartStatus: ChartStatus = ChartStatus.Unknown) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return SetChartStatus.createSetChartStatus(builder, this.chartStatus);
  }
}
