...
export class ProfitScaleDealCommission implements flatbuffers.IUnpackableObject<ProfitScaleDealCommissionT> {
  ...
  static getRootAsProfitScaleDealCommission(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealCommission,
  ): ProfitScaleDealCommission {
    return (obj || new ProfitScaleDealCommission()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsProfitScaleDealCommission(
    bb: flatbuffers.ByteBuffer,
    obj?: ProfitScaleDealCommission,
  ): ProfitScaleDealCommission {
  ...
  unpack(): ProfitScaleDealCommissionT {
    return new ProfitScaleDealCommissionT(this.commission());
  }
...
export class ProfitScaleDealCommissionT implements flatbuffers.IGeneratedObject {
  constructor(public commission: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return ProfitScaleDealCommission.createProfitScaleDealCommission(builder, this.commission);
  }
}
