...
export class DealExpiration implements flatbuffers.IUnpackableObject<DealExpirationT> {
  ...
  unpack(): DealExpirationT {
    return new DealExpirationT(this.expiration() !== null ? this.expiration()!.unpack() : null);
  }
...
export class DealExpirationT implements flatbuffers.IGeneratedObject {
  constructor(public expiration: TimeT | null = null) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return DealExpiration.createDealExpiration(builder, this.expiration !== null ? this.expiration.pack(builder) : 0);
  }
}
