...
export class StartLastCandleAnimation implements flatbuffers.IUnpackableObject<StartLastCandleAnimationT> {
  ...
  static getRootAsStartLastCandleAnimation(
    bb: flatbuffers.ByteBuffer,
    obj?: StartLastCandleAnimation,
  ): StartLastCandleAnimation {
    return (obj || new StartLastCandleAnimation()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsStartLastCandleAnimation(
    bb: flatbuffers.ByteBuffer,
    obj?: StartLastCandleAnimation,
  ): StartLastCandleAnimation {
...
export class StartLastCandleAnimationT implements flatbuffers.IGeneratedObject {
  constructor() {}
