...
import type { IconTypeT } from '../../milky/model/icon-type.js';
import { IconType } from '../../milky/model/icon-type.js';
...
export class BaseAnimation implements flatbuffers.IUnpackableObject<BaseAnimationT> {
...
export class BaseAnimationT implements flatbuffers.IGeneratedObject {
  constructor(
