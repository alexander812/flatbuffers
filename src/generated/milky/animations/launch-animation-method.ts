...
import type { LabelAnimationT } from '../../milky/animations/label-animation.js';
import { LabelAnimation } from '../../milky/animations/label-animation.js';
import type { SplashAnimationT } from '../../milky/animations/splash-animation.js';
import { SplashAnimation } from '../../milky/animations/splash-animation.js';
...
export class LaunchAnimationMethod implements flatbuffers.IUnpackableObject<LaunchAnimationMethodT> {
  ...
  static getRootAsLaunchAnimationMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: LaunchAnimationMethod,
  ): LaunchAnimationMethod {
    return (obj || new LaunchAnimationMethod()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsLaunchAnimationMethod(
    bb: flatbuffers.ByteBuffer,
    obj?: LaunchAnimationMethod,
  ): LaunchAnimationMethod {
  ...
  static createLaunchAnimationMethod(
    builder: flatbuffers.Builder,
    animationModelType: Animations,
    animationModelOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
...
export class LaunchAnimationMethodT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return LaunchAnimationMethod.createLaunchAnimationMethod(builder, this.animationModelType, animationModel);
  }
}
