...
import type { LaunchAnimationMethodT } from '../../milky/animations/launch-animation-method.js';
import { LaunchAnimationMethod } from '../../milky/animations/launch-animation-method.js';
import { Methods, unionToMethods, unionListToMethods } from '../../milky/animations/methods.js';
import type { RemoveAllAnimationsMethodT } from '../../milky/animations/remove-all-animations-method.js';
import { RemoveAllAnimationsMethod } from '../../milky/animations/remove-all-animations-method.js';
...
export class RequestT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: LaunchAnimationMethodT | RemoveAllAnimationsMethodT | null = null,
  ) {}
