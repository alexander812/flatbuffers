...
export class Add implements flatbuffers.IUnpackableObject<AddT> {
...
export class AddT implements flatbuffers.IGeneratedObject {
  constructor(public id: NotificationLevelIdT | null = null, public quote: QuoteT | null = null) {}
