...
export function unionToMethods(
  ...
  switch (Methods[type]) {
    case 'NONE':
      return null;
    case 'Add':
      return accessor(new Add())! as Add;
    case 'Remove':
      return accessor(new Remove())! as Remove;
    case 'Update':
      return accessor(new Update())! as Update;
    case 'SetAutoHide':
      return accessor(new SetAutoHide())! as SetAutoHide;
    default:
      return null;
  }
}
...
export function unionListToMethods(
  ...
  switch (Methods[type]) {
    case 'NONE':
      return null;
    case 'Add':
      return accessor(index, new Add())! as Add;
    case 'Remove':
      return accessor(index, new Remove())! as Remove;
    case 'Update':
      return accessor(index, new Update())! as Update;
    case 'SetAutoHide':
      return accessor(index, new SetAutoHide())! as SetAutoHide;
    default:
      return null;
  }
}
