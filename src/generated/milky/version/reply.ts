...
import type { VersionInfoT } from '../../milky/model/version/version-info.js';
import { VersionInfo } from '../../milky/model/version/version-info.js';
import { ResultsReply, unionToResultsReply, unionListToResultsReply } from '../../milky/version/results-reply.js';
...
export class Reply implements flatbuffers.IUnpackableObject<ReplyT> {
  ...
  unpack(): ReplyT {
    return new ReplyT(
      this.resultType(),
      (() => {
        const temp = unionToResultsReply(this.resultType(), this.result.bind(this));
        if (temp === null) {
          return null;
        }
        return temp.unpack();
