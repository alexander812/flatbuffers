...
export class OnRequestData implements flatbuffers.IUnpackableObject<OnRequestDataT> {
  ...
  unpack(): OnRequestDataT {
    return new OnRequestDataT(this.timeFrame(), this.start() !== null ? this.start()!.unpack() : null, this.count());
  }
...
export class OnRequestDataT implements flatbuffers.IGeneratedObject {
  constructor(public timeFrame: number = 0, public start: TimeT | null = null, public count: number = 0) {}
