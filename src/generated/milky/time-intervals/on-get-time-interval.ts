...
export class OnGetTimeInterval implements flatbuffers.IUnpackableObject<OnGetTimeIntervalT> {
  ...
  static getSizePrefixedRootAsOnGetTimeInterval(
    bb: flatbuffers.ByteBuffer,
    obj?: OnGetTimeInterval,
  ): OnGetTimeInterval {
...
export class OnGetTimeIntervalT implements flatbuffers.IGeneratedObject {
  constructor(
