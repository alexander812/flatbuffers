...
import type { TimeFrameT } from '../../milky/time-intervals/time-frame.js';
import { TimeFrame } from '../../milky/time-intervals/time-frame.js';

export class SetTimeFramesTable implements flatbuffers.IUnpackableObject<SetTimeFramesTableT> {
  ...
  static getSizePrefixedRootAsSetTimeFramesTable(
    bb: flatbuffers.ByteBuffer,
    obj?: SetTimeFramesTable,
  ): SetTimeFramesTable {
  ...
  static createSetTimeFramesTable(
    builder: flatbuffers.Builder,
    timeFrameTableOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
  ...
  unpack(): SetTimeFramesTableT {
    return new SetTimeFramesTableT(
      this.bb!.createObjList<TimeFrame, TimeFrameT>(this.timeFrameTable.bind(this), this.timeFrameTableLength()),
    );
  }

  unpackTo(_o: SetTimeFramesTableT): void {
    _o.timeFrameTable = this.bb!.createObjList<TimeFrame, TimeFrameT>(
      this.timeFrameTable.bind(this),
      this.timeFrameTableLength(),
    );
  }
}

export class SetTimeFramesTableT implements flatbuffers.IGeneratedObject {
  constructor(public timeFrameTable: TimeFrameT[] = []) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    const timeFrameTable = SetTimeFramesTable.createTimeFrameTableVector(
      builder,
      builder.createObjectOffsetList(this.timeFrameTable),
    );

    return SetTimeFramesTable.createSetTimeFramesTable(builder, timeFrameTable);
  }
}
