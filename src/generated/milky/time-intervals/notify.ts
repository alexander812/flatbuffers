...
import { Notifies, unionToNotifies, unionListToNotifies } from '../../milky/time-intervals/notifies.js';
import type { OnGetTimeIntervalT } from '../../milky/time-intervals/on-get-time-interval.js';
import { OnGetTimeInterval } from '../../milky/time-intervals/on-get-time-interval.js';
import type { OnRequestDataT } from '../../milky/time-intervals/on-request-data.js';
import { OnRequestData } from '../../milky/time-intervals/on-request-data.js';
...
export class NotifyT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method: OnGetTimeIntervalT | OnRequestDataT | null = null,
  ) {}
