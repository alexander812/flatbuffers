...
import type { AddIndicatorMethodT } from '../../milky/indicator/add-indicator-method.js';
import { AddIndicatorMethod } from '../../milky/indicator/add-indicator-method.js';
import type { GetActiveIndicatorsIdsMethodT } from '../../milky/indicator/get-active-indicators-ids-method.js';
import { GetActiveIndicatorsIdsMethod } from '../../milky/indicator/get-active-indicators-ids-method.js';
import type { HoverIndicatorMethodT } from '../../milky/indicator/hover-indicator-method.js';
import { HoverIndicatorMethod } from '../../milky/indicator/hover-indicator-method.js';
import { Methods, unionToMethods, unionListToMethods } from '../../milky/indicator/methods.js';
import type { RemoveAllIndicatorsMethodT } from '../../milky/indicator/remove-all-indicators-method.js';
import { RemoveAllIndicatorsMethod } from '../../milky/indicator/remove-all-indicators-method.js';
import type { RemoveIndicatorMethodT } from '../../milky/indicator/remove-indicator-method.js';
import { RemoveIndicatorMethod } from '../../milky/indicator/remove-indicator-method.js';
import type { SetIndicatorComponentValueMethodT } from '../../milky/indicator/set-indicator-component-value-method.js';
import { SetIndicatorComponentValueMethod } from '../../milky/indicator/set-indicator-component-value-method.js';
import type { UnhoverIndicatorMethodT } from '../../milky/indicator/unhover-indicator-method.js';
import { UnhoverIndicatorMethod } from '../../milky/indicator/unhover-indicator-method.js';
...
export class RequestT implements flatbuffers.IGeneratedObject {
  constructor(
    ...
    public method:
      ...
      | HoverIndicatorMethodT
      | RemoveAllIndicatorsMethodT
      | RemoveIndicatorMethodT
      | SetIndicatorComponentValueMethodT
      | UnhoverIndicatorMethodT
      | null = null,
  ) {}
