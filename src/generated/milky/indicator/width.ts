...
export class Width implements flatbuffers.IUnpackableObject<WidthT> {
...
export class WidthT implements flatbuffers.IGeneratedObject {
  constructor(public value: number = 0.0) {}

  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    return Width.createWidth(builder, this.value);
  }
}
